...
//        jCheckBoxMenuItemStartupCRCLWebApp.setSelected(false);
    ...
    public boolean isPddlExecutorStartupSelected() {
        return jCheckBoxMenuItemStartupPDDLExecutor.isSelected();
    }

    public void setPddlExecutorStartupSelected(boolean selected) {
        jCheckBoxMenuItemStartupPDDLExecutor.setSelected(selected);
    }
...
//                closePddlPlanner();
    ...
    private void startConnectDatabase() {
        if (null != aprsSystem) {
            aprsSystem.startConnectDatabase();
        } else {
            throw new IllegalStateException("aprsSystem ==null, this=" + this);
        }
    }
    ...
    private void startDisconnectDatabase() {
        if (null != aprsSystem) {
            aprsSystem.startDisconnectDatabase();
        } else {
            throw new IllegalStateException("aprsSystem ==null, this=" + this);
        }
    }
