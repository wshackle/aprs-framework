...
public class PosMatchJPanel extends javax.swing.JPanel {
    ...
    @Nullable public static PosMatch bestMatch(String name, List<PmCartesian> posList1, List<PmCartesian> posList2, double maxDist) {
        int bestL1Index = -1;
        int bestL2Index = -1;
    ...
    public static List<PosMatch> match(String name, @Nullable List<PmCartesian> posList1, @Nullable List<PmCartesian> posList2) {
