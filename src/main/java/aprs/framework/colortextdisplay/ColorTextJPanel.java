...
public class ColorTextJPanel extends javax.swing.JPanel {
    ...
    @Nullable public static Icon getRobotIcon(String name) {
        ...
        if (name.toUpperCase().contains("MOTOMAN")) {
            return getClassResourceIcon("/aprs/framework/screensplash/motoman_small.png");
        } else if (name.toUpperCase().contains("FANUC")) {
            return getClassResourceIcon("/aprs/framework/screensplash/fanuc_small.png");
        } else {
            return getClassResourceIcon("/aprs/framework/screensplash/" + name.toLowerCase() + "_small.png");
        }
    }
