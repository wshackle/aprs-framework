...
public class Object2DOuterDialogPanel extends javax.swing.JPanel {
    ...
    public static boolean showObject2DDialog(@Nullable Frame owner, String title, boolean modal, Properties props, List<PhysicalItem> items) {
    ...
    @Nullable
    @SuppressWarnings("nullness")
    public static boolean showObject2DDialog(@Nullable Frame owner, String title,
            boolean modal, File propsFile,
            File itemsFile) {
        Object2DOuterDialogPanel panel = new Object2DOuterDialogPanel();
        try {
            panel.dialog = new JDialog(owner, title, modal);
